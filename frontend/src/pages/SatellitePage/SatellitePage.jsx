    ...
    return satelliteData === null ? <h1 className="text-3xl">Загрузка...</h1> : (
        <div className="flex flex-row justify-between">
            ...
            <table className="w-[12.5%] h-full mx-4 border border-gray-600 rounded-md">
                ...
                />
                <tr>
                    <th className="w-1/2 border border-gray-600">Время, UTC</th>
                    <LiveClock
                ...
                <tr>
                    <th className="w-1/2 border border-gray-600">Местное время</th>
                    <LiveClock
                        ref={el => updatableComponentsRef.current[4] = el}
                        localTime={true} className="w-1/2 border border-gray-600"
                    />
                </tr>
                </tbody>
            </table>

            {satelliteData.passes.length === 0 ? <p className="w-1/3 text-center">В близжайшие сутки пролетов нет</p> : (
